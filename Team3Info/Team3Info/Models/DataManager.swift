...
class DataManager {
    ...
    func makeMemberData() {
        memberArray = [
            ...
            Member(profileImage: UIImage(named: "Heather"), memberName: "조희라", memberNickName: "@Heather", detailImage: UIImage(named: "Heather_profile"),memberEmail: "malne14@naver.com", memberBirth: "02.20", memberTag: "#INTJ", memberIntroduce: "안녕하세요! 효율적인걸 좋아하는 개발자 새싹입니다.:) 열심히 해서 이커머스 관련 iOS앱을 개발하고싶어요.", memberBlog: "https://velog.io/@malne14/posts", memberGithub: "https://github.com/Heather-Cho"),
